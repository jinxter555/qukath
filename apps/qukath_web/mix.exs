defmodule QukathWeb.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:phoenix_live_view, git: "https://github.com/phoenixframework/phoenix_live_view", branch: "master", override: true},
